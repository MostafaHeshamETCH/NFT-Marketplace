      ...
      <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          <a href="/" class="flex items-center">
            <img
              src="https://play-lh.googleusercontent.com/Nf1iIV3US6zvXNuNIDDB6L2VfXQGhstCPoJF93nTJMGeyODhgH1J6vyOj7glcjQSUkI=w280-h280"
          ...
          <div class="flex md:order-2">
            <Link href="create-nft">
              <button
                type="button"
                class="text-white bg-violet-800 hover:bg-violet-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0"
              >
                Create NFT
              </button>
            </Link>
          ...
          >
            <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link href="/">
                  <a
                    class="block py-2 pr-4 pl-3 bg-violet-800 rounded md:bg-transparent md:p-0 text-white"
                    aria-current="page"
                  >
                    Home
                  </a>
